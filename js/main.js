...
var url ="http://api.yummly.com/v1/api/recipes?_app_id=d77dde75&_app_key=4a28aa62c4333836b11ef718e632218f&"+keywords+"&requirePictures=true"+"&callback=data";  
    $.ajax({                                                                            
      type: 'GET',
       url: url,
       dataType: 'jsonp',
       ...
       success: function(data) { 
        ...
        if(i%2 ===0){
          $('ul.list-recipe').append("<li class ='1'><h4>"+data1[i].id+"</h4></li>");
          $("li.1").css("background","#f6f6f6 ");
          console.log("imhere");
          // console.log(i);
        }else{
          $('ul.list-recipe').append("<li class ='2'><h4>"+data1[i].id+"</h4></li>");
          $("li.2").css("background","#f1f1f1");
          console.log("imthere");
        }
      }
